            ...
            async.when(
              ...
              data: (list) {
                ...
                final totalDue = unpaid.fold<double>(
                    ...
                    (s, x) =>
                        s +
                        (((x as Map)['amount'] as num?)?.toDouble() ?? 0));
                return SliverList(
                  delegate: SliverChildListDelegate([
                    // Summary banner
                    if (unpaid.isNotEmpty)
                      _SummaryBanner(
                          unpaidCount: unpaid.length, totalDue: totalDue),
                    if (unpaid.isNotEmpty) ...[
                      const Padding(
                      ...
                      ...unpaid.asMap().entries.map((e) => _InvoiceCard(
                    ...
                    if (paid.isNotEmpty) ...[
                      ...
                      ...paid.asMap().entries.map((e) => _InvoiceCard(
                          item: e.value as Map<String, dynamic>,
...
class _SummaryBanner extends StatelessWidget {
  ...
  const _SummaryBanner(
      {required this.unpaidCount, required this.totalDue});
...
class _Empty extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Column(children: [
          ...
          const Text('Your payment records will appear here.',
