...
class _VocabDayCard extends StatelessWidget {
  ...
  final WidgetRef ref;
  const _VocabDayCard(
      {required this.item, required this.index, required this.ref});
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading: _DayCircle(
              dayNumber: dayNumber, isCompleted: isCompleted),
          title: Text(
            displayTitle,
            style: const TextStyle(
  ...
  Future<void> _markComplete(
      BuildContext context, dynamic id, WidgetRef ref) async {
    try {
