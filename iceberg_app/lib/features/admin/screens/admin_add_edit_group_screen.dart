...
class _AdminAddEditGroupScreenState
  ...
  Future<void> _loadGroup() async {
    ...
    try {
      ...
      _teacherId = teacher is int ? teacher : (teacher is Map ? teacher['id'] as int? : null);
    ...
    try {
      if (widget.isEdit) {
        await ApiClient.instance.dio
            .patch('/admin/groups-manage/${widget.groupId}/', data: body);
      } else {
        await ApiClient.instance.dio
            .post('/admin/groups-manage/', data: body);
      }
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(children: [
                  ...
                  _field(_schedule, 'Schedule (optional)',
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text('Capacity: $_capacity students',
                              style: const TextStyle(
                  ...
                  _field(_fee, 'Monthly Fee (UZS, optional)',
