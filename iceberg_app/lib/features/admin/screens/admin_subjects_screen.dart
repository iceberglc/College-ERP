...
class _AdminSubjectsScreenState extends ConsumerState<AdminSubjectsScreen> {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx2, setSheetState) => _SubjectFormSheet(
          ...
          onSave: () async {
            if (nameCtrl.text.trim().isEmpty || selectedCourseId == null) return;
            final data = {
            ...
            try {
              if (subject == null) {
                await ApiClient.instance.dio
                    .post('/admin/subjects/', data: data);
              } else {
                await ApiClient.instance.dio
                    .patch('/admin/subjects/${subject['id']}/', data: data);
              }
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    return _subjects.where((s) {
      final courseId = s['course'] is Map
          ? s['course']['id']
          : s['course'];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 4),
          const Icon(Icons.edit_outlined, size: 16, color: IceColors.muted),
        ]),
      ),
    )
          ...
          Row(children: [
            ...
            if (showDelete && onDelete != null) ...[
              ...
              IconButton(
                onPressed: onDelete,
                icon:
                    const Icon(Icons.delete_outline, color: IceColors.danger),
                tooltip: 'Delete',
              ),
            ],
          ]),
