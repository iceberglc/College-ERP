...
class _State extends State<StaffVocabularyDetailScreen> {
  ...
  Future<void> _fetch() async {
    ...
    try {
      final res = await ApiClient.instance.dio
          .get('/staff/vocabulary/${widget.vocabId}/');
  ...
  Future<void> _deleteWord(dynamic wordId) async {
    try {
      await ApiClient.instance.dio
          .delete('/staff/vocabulary/${widget.vocabId}/words/$wordId/');
      await _fetch();
      if (mounted) {
  ...
  Future<void> _addWord(
      String english, String translation, String example) async {
    try {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('No words yet',
                        style: TextStyle(
                            fontSize: 14, color: IceColors.muted)),
                    SizedBox(height: 4),
                    Text('Tap "Add Word" to add the first word.',
...
class _WordRow extends StatelessWidget {
  ...
  const _WordRow({required this.word, required this.index, required this.onDelete});
        ...
        children: [
          ...
          IconButton(
            ...
            icon: const Icon(Icons.delete_outline_rounded,
                size: 20, color: IceColors.danger),
